...
def _make_findings(tmp_path: Path) -> Path:
    payload = {
        ...
        "summary": {"total_variables": 4, "covered": 1, "name_phi_uncovered": 2, "column_shape_phi_uncovered": 0, "review_required_open": 1},
        "findings": [
            {"form": "F1", "variable_id_masked": "abc123def456", "category": "covered", "regulatory_anchor_hint": None, "current_action": "pseudonymize"},
            {"form": "F1", "variable_id_masked": "111111111111", "category": "name_phi_uncovered", "regulatory_anchor_hint": "HIPAA #5 (phone)", "current_action": "keep"},
            {"form": "F2", "variable_id_masked": "222222222222", "category": "name_phi_uncovered", "regulatory_anchor_hint": "HIPAA #5 (phone)", "current_action": "keep"},
            {"form": "F2", "variable_id_masked": "333333333333", "category": "review_required_open", "regulatory_anchor_hint": None, "current_action": "review_required"},
        ],
    }
...
def test_pr_draft_one_per_anchor(tmp_path: Path) -> None:
    ...
    emit_drafts(findings_path=findings, pr_drafts_dir=tmp_path / "pr", hitl_drafts_dir=tmp_path / "hitl")
